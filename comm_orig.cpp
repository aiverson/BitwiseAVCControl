...
int send_some_stuff(int serial_fd)
{
	int fd = serial_fd;
...
//		mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_encode(21, 0, &message, &sp);
//		unsigned len = mavlink_msg_to_send_buffer((uint8_t*)buf, &message);
